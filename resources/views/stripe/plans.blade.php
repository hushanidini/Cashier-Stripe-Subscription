                ...
                <div class="pricing pricing-palden">
                    @if ($basic)
                        <div class="pricing-item">
                            ...
                            <a href="{{ route('plans.checkout', $basic->plan_id) }}" class="pricing-action l-amber">Start Free Trial Now</a>
                        </div>
                    @endif
                    ...
                    @if ($professional)
                        <div class="pricing-item pricing__item--featured">
                            ...
                            <a href="{{ route('plans.checkout', $professional->plan_id) }}" class="pricing-action l-amber">Start Free Trial Now</a>
                        </div>
                    @endif
                    ...
                    @if ($enterprise)
                        <div class="pricing-item">
                            ...
                            <a href="{{ route('plans.checkout', $enterprise->plan_id) }}" class="pricing-action l-amber">Start Free Trial Now</a>
                        </div>
